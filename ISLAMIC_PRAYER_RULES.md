...
**Musafir mode** (`trip_mode=travel`): combining (Jam' Taqdeem / Ta'kheer) options are included.
**Muqeem mode** (`trip_mode=driving`): only separate stops and pray-before / at-destination options are included.
