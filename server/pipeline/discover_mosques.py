...
SEARCH_GRID = [
    ...
    # === US ADDITIONAL — College Towns & Smaller Cities ===
    # College towns with significant Muslim student populations
    ("Ann Arbor-Ypsilanti MI", 42.2808, -83.7430, 20000),
    ("Champaign-Urbana IL", 40.1164, -88.2434, 15000),
    ("State College PA", 40.7934, -77.8600, 15000),
    ("Ithaca NY", 42.4440, -76.5019, 15000),
    ("Gainesville FL", 29.6516, -82.3248, 15000),
    ("College Station TX", 30.6280, -96.3344, 15000),
    ("Iowa City IA", 41.6611, -91.5302, 15000),
    ("Bloomington IN", 39.1653, -86.5264, 15000),
    ("East Lansing MI", 42.7370, -84.4839, 15000),
    ("Blacksburg VA", 37.2296, -80.4139, 15000),
    ("Amherst MA", 42.3732, -72.5199, 15000),
    ("New Brunswick NJ", 40.4863, -74.4518, 15000),
    ("Davis CA", 38.5449, -121.7405, 15000),
    ("Chapel Hill NC", 35.9132, -79.0558, 15000),
    ("Tallahassee FL", 30.4383, -84.2807, 20000),
    ("Knoxville TN", 35.9606, -83.9207, 20000),
    ("Lexington KY", 38.0406, -84.5037, 20000),
    ("Columbia MO", 38.9517, -92.3341, 15000),
    ("Norman OK", 35.2226, -97.4395, 15000),
    ("Tucson U of A area", 32.2319, -110.9501, 15000),
    ("Tempe AZ (ASU)", 33.4255, -111.9400, 15000),
    ("Corvallis OR", 44.5646, -123.2620, 15000),
    ("Madison-UW WI", 43.0766, -89.4125, 15000),

    # Smaller US cities with known Muslim communities
    ("Bridgeport CT", 41.1792, -73.1894, 20000),
    ("Stamford CT", 41.0534, -73.5387, 15000),
    ("Paterson NJ", 40.9168, -74.1718, 15000),
    ("Yonkers NY", 40.9312, -73.8987, 15000),
    ("Trenton NJ", 40.2171, -74.7429, 15000),
    ("Wilmington DE", 39.7391, -75.5398, 15000),
    ("Scranton PA", 41.4090, -75.6624, 15000),
    ("Harrisburg PA", 40.2732, -76.8867, 15000),
    ("Akron OH", 41.0814, -81.5190, 15000),
    ("Dayton OH", 39.7589, -84.1916, 20000),
    ("Toledo OH", 41.6528, -83.5379, 15000),
    ("Grand Rapids MI", 42.9634, -85.6681, 20000),
    ("Flint MI", 43.0125, -83.6875, 15000),
    ("Lansing MI", 42.7325, -84.5555, 15000),
    ("Springfield MA", 42.1015, -72.5898, 15000),
    ("Worcester MA", 42.2626, -71.8023, 15000),
    ("Lowell MA", 42.6334, -71.3162, 15000),
    ("Portland ME", 43.6591, -70.2568, 15000),
    ("Manchester NH", 42.9956, -71.4548, 15000),
    ("Norfolk VA", 36.8508, -76.2859, 20000),
    ("Greensboro NC", 36.0726, -79.7920, 20000),
    ("Durham NC", 35.9940, -78.8986, 15000),
    ("Fayetteville NC", 35.0527, -78.8784, 15000),
    ("Savannah GA", 32.0809, -81.0912, 15000),
    ("Augusta GA", 33.4735, -82.0105, 15000),
    ("Mobile AL", 30.6954, -88.0399, 15000),
    ("Huntsville AL", 34.7304, -86.5861, 20000),
    ("Jackson MS", 32.2988, -90.1848, 15000),
    ("Shreveport LA", 32.5252, -93.7502, 15000),
    ("Wichita KS", 37.6872, -97.3301, 20000),
    ("Lincoln NE", 40.8258, -96.6852, 15000),
    ("Sioux Falls SD", 43.5446, -96.7311, 15000),
    ("Fargo ND", 46.8772, -96.7898, 15000),
    ("Billings MT", 45.7833, -108.5007, 15000),
    ("Spokane WA", 47.6588, -117.4260, 15000),
    ("Reno NV", 39.5296, -119.8138, 15000),
    ("Colorado Springs", 38.8339, -104.8214, 20000),
    ("Fort Collins CO", 40.5853, -105.0844, 15000),
    ("Lubbock TX", 33.5779, -101.8552, 15000),
    ("Beaumont TX", 30.0802, -94.1266, 15000),
    ("Corpus Christi TX", 27.8006, -97.3964, 15000),
    ("Laredo TX", 27.5036, -99.5076, 15000),
    ("Anchorage AK", 61.2181, -149.9003, 25000),

    # === CANADA ADDITIONAL — Smaller Cities ===
    ("Windsor ON", 42.3149, -83.0364, 15000),
    ("Guelph ON", 43.5448, -80.2482, 15000),
    ("St Catharines ON", 43.1594, -79.2469, 15000),
    ("Oshawa ON", 43.8971, -78.8658, 15000),
    ("Victoria BC", 48.4284, -123.3656, 20000),
    ("Kelowna BC", 49.8880, -119.4960, 15000),
    ("Abbotsford BC", 49.0504, -122.3045, 15000),
    ("Fredericton NB", 45.9636, -66.6431, 15000),
    ("Moncton NB", 46.0878, -64.7782, 15000),
    ("St Johns NL", 47.5615, -52.7126, 15000),
    ("Charlottetown PEI", 46.2382, -63.1311, 15000),
    ("Waterloo ON", 43.4643, -80.5204, 15000),
    ("Markham ON", 43.8561, -79.3370, 15000),
    ("Richmond Hill ON", 43.8828, -79.4403, 15000),
    ("Vaughan ON", 43.8361, -79.4983, 15000),
    ("Ajax-Pickering ON", 43.8509, -79.0204, 15000),
    ("Scarborough ON", 43.7731, -79.2577, 15000),
    ("Etobicoke ON", 43.6205, -79.5132, 15000),
    ("North York ON", 43.7615, -79.4111, 15000),
    ("Laval QC", 45.5590, -73.6920, 15000),
    ("Gatineau QC", 45.4765, -75.7013, 15000),
